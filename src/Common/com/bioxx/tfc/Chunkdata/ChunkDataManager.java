...
public class ChunkDataManager 
{
	...
	public final HashMap<Long,ChunkData> chunkmap = new HashMap<>();
	...
	{
		chunkmap.put(ChunkCoordIntPair.chunkXZ2Int(chunk.xPosition, chunk.zPosition), cd);
	}

	public void addData(int x, int z, ChunkData cd)
	{
		chunkmap.put(ChunkCoordIntPair.chunkXZ2Int(x, z), cd);
	}
