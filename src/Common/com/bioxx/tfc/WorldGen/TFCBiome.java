...
public class TFCBiome extends BiomeGenBase
{
	...
	public static final TFCBiome DEEP_OCEAN = new TFCBiome(36).setBiomeName("Deep Ocean").setMinMaxHeight(-1.5F, 0.00001F).setBiomeColor(0x0e055a).setTemperatureRainfall(0.0F, 0.0F);

	public static final TFCBiome OCEAN = new TFCBiome(0).setBiomeName("Ocean").setMinMaxHeight(-0.9F, 0.00001F).setBiomeColor(0x0000ff).setTemperatureRainfall(2.0F, 0.0F);
	public static final TFCBiome BEACH = new TFCBiome(16).setColor(0xfade55).setBiomeName("Beach").setMinMaxHeight(0.01F, 0.02F).setBiomeColor(0xffb873).setTemperatureRainfall(2.0F, 0.0F);
	public static final TFCBiome GRAVEL_BEACH = new TFCBiome(17).setColor(0xfade55).setBiomeName("Gravel Beach").setMinMaxHeight(0.01F, 0.02F).setBiomeColor(0x8f7963).setTemperatureRainfall(2.0F, 0.0F);
	public static final TFCBiome RIVER = new TFCBiome(7).setBiomeName("River").setMinMaxHeight(riverDepthMin, riverDepthMax).setBiomeColor(0xffffff).setTemperatureRainfall(4.0F, 0.0F);
	public static final TFCBiome LAKE = new TFCBiome(2).setBiomeName("Lake").setMinMaxHeight(-0.5F, 0.001F).setBiomeColor(0x4a8e9e).setLilyPads(2).setTemperatureRainfall(5.0F, 0.0F);
	public static final TFCBiome HELL = new TFCBiome(8).setColor(16711680).setBiomeName("Hell").setDisableRain().setTemperatureRainfall(20.0F, 0.0F);
	public static final TFCBiome HIGH_HILLS = new TFCBiome(3).setBiomeName("High Hills").setMinMaxHeight(0.8F, 1.6F).setBiomeColor(0x044f27).setTemperatureRainfall(2.0F, 0.0F);
	public static final TFCBiome PLAINS = new TFCBiome(1).setBiomeName("Plains").setMinMaxHeight(0.1F, 0.16F).setBiomeColor(0x69dfa0).setTemperatureRainfall(5.0F, 0.0F);
	public static final TFCBiome SWAMPLAND = new TFCBiome(6).setBiomeName("Swamp").setMinMaxHeight(-0.1F, 0.1F).setBiomeColor(0x1f392b).setLilyPads(8).setWaterPlants(45).setTemperatureRainfall(5.5F, 0.0F);
	public static final TFCBiome HIGH_HILLS_EDGE = new TFCBiome(20).setBiomeName("High Hills Edge").setMinMaxHeight(0.2F, 0.4F).setBiomeColor(0x30a767).setTemperatureRainfall(2.0F, 0.0F);
	public static final TFCBiome ROLLING_HILLS = new TFCBiome(30).setBiomeName("Rolling Hills").setMinMaxHeight(0.1F, 0.4F).setBiomeColor(0x87b434).setTemperatureRainfall(2.0F, 0.0F);
	public static final TFCBiome MOUNTAINS = new TFCBiome(31).setBiomeName("Mountains").setMinMaxHeight(0.8F, 1.6F).setBiomeColor(0x707960).setTemperatureRainfall(1.5F, 0.0F);
	public static final TFCBiome MOUNTAINS_EDGE = new TFCBiome(32).setBiomeName("Mountains Edge").setMinMaxHeight(0.4F, 0.8F).setBiomeColor(0xb2bc9f).setTemperatureRainfall(2.0F, 0.0F);
	public static final TFCBiome HIGH_PLAINS = new TFCBiome(35).setBiomeName("High Plains").setMinMaxHeight(0.4F, 0.43F).setBiomeColor(0xa6a41c).setTemperatureRainfall(3.0F, 0.0F);
	public static final TFCBiome JUNGLE = new TFCBiome(21).setBiomeName("Jungle").setMinMaxHeight(0.2F, 0.23F).setBiomeColor(0x3bbb0b).setTemperatureRainfall(6.0F, 0.0F).setLilyPads(2).setWaterPlants(10);
