...
public class TFC_ConfigFiles
{
	...
	public static void reloadOres()
	{
		...
		oreList.put("Cassiterite"    , getOreData("Cassiterite"  ,"veins",  "medium", MOD_ID + ":Ore1", 5,  100, new String[]{"igneous intrusive", "igneous extrusive"},                   5, 110, 60, 40));
		...
		oreList.put("Magnetite"      , getOreData("Magnetite"    ,"veins",  "medium", MOD_ID + ":Ore1", 10, 100, new String[]{"sedimentary"},                                              5, 110, 60, 40));
		...
		oreList.put("Kaolinite"      , getOreData("Kaolinite"    ,"default","medium", MOD_ID + ":Ore2", 0,   40, new String[]{"sedimentary", "metamorphic"},                               5, 110, 60, 40));
		oreList.put("Gypsum"         , getOreData("Gypsum"       ,"veins",  "large",  MOD_ID + ":Ore2", 1,   70, new String[]{"sedimentary"},                                              5, 110, 60, 40));
		oreList.put("Graphite"       , getOreData("Graphite"     ,"veins",  "medium", MOD_ID + ":Ore2", 4,   50, new String[]{"metamorphic", "sedimentary"},                               5, 110, 60, 40));
