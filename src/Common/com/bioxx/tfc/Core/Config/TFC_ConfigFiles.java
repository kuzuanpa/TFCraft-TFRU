...
public class TFC_ConfigFiles
{
	...
	public static void reloadOres()
	{
		...
		oreList.put("Native Copper"  , getOreData("Native Copper","veins",  "large",  MOD_ID + ":Ore1", 0,   70, new String[]{"igneous extrusive", "igneous intrusive"},                   5, 110, 60, 40));
		oreList.put("Native Gold"    , getOreData("Native Gold"  ,"veins",  "large",  MOD_ID + ":Ore1", 1,   70, new String[]{"igneous extrusive", "igneous intrusive"},                   5, 110, 60, 40));
		oreList.put("Platinum"       , getOreData("Platinum"     ,"veins",  "small",  MOD_ID + ":Ore1", 2,  100, new String[]{"sedimentary"},                                              5, 110, 20, 60));
		oreList.put("Hematite"       , getOreData("Hematite"     ,"veins",  "large",  MOD_ID + ":Ore1", 3,   75, new String[]{"igneous extrusive"},                                        5, 110, 60, 40));
		oreList.put("Silver"         , getOreData("Silver"       ,"veins",  "medium", MOD_ID + ":Ore1", 4,   50, new String[]{"sedimentary", "metamorphic"},                               5, 110, 60, 40));
		oreList.put("Cassiterite"    , getOreData("Cassiterite"  ,"veins",  "medium", MOD_ID + ":Ore1", 5,   70, new String[]{"igneous intrusive", "igneous extrusive"},                   5, 110, 60, 40));
		oreList.put("Galena"         , getOreData("Galena"       ,"veins",  "medium", MOD_ID + ":Ore1", 6,   50, new String[]{"igneous extrusive", "metamorphic", "sedimentary"},          5, 110, 60, 40));
		oreList.put("Garnierite"     , getOreData("Garnierite"   ,"veins",  "medium", MOD_ID + ":Ore1", 8,  100, new String[]{"gabbro","basalt","diorite"},                                5, 110, 60, 40));
		oreList.put("Malachite"      , getOreData("Malachite"    ,"veins",  "large",  MOD_ID + ":Ore1", 9,   50, new String[]{"metamorphic"},                                              5, 110, 60, 40));
		oreList.put("Magnetite"      , getOreData("Magnetite"    ,"veins",  "medium", MOD_ID + ":Ore1", 10,  80, new String[]{"sedimentary"},                                              5, 110, 60, 40));
		oreList.put("Limonite"       , getOreData("Limonite"     ,"veins",  "medium", MOD_ID + ":Ore1", 11,  50, new String[]{"sedimentary"},                                              5, 110, 60, 40));
		oreList.put("Sphalerite"     , getOreData("Sphalerite"   ,"veins",  "medium", MOD_ID + ":Ore1", 12,  50, new String[]{"metamorphic"},                                              5, 110, 60, 40));
		oreList.put("Tetrahedrite"   , getOreData("Tetrahedrite" ,"veins",  "medium", MOD_ID + ":Ore1", 13,  70, new String[]{"metamorphic","sedimentary"},                                5, 110, 60, 40));
		oreList.put("Lignite"        , getOreData("Lignite"      ,"default","medium", MOD_ID + ":Ore1", 15,  50, new String[]{"metamorphic"},                                              5, 110, 70, 20));
		oreList.put("Kaolinite"      , getOreData("Kaolinite"    ,"default","medium", MOD_ID + ":Ore2", 0,  100, new String[]{"sedimentary", "metamorphic"},                               5, 110, 60, 40));
		oreList.put("Gypsum"         , getOreData("Gypsum"       ,"veins",  "large",  MOD_ID + ":Ore2", 1,   70, new String[]{"sedimentary"},                                              5, 110, 60, 40));
		oreList.put("Graphite"       , getOreData("Graphite"     ,"veins",  "medium", MOD_ID + ":Ore2", 4,  100, new String[]{"metamorphic", "sedimentary"},                               5, 110, 60, 40));
		oreList.put("Kimberlite"     , getOreData("Kimberlite"   ,"veins",  "medium", MOD_ID + ":Ore2", 5,  150, new String[]{"gabbro","basalt","diorite"},                                5, 110, 15, 60));
		oreList.put("Jet"            , getOreData("Jet"          ,"veins",  "medium", MOD_ID + ":Ore2", 8,   60, new String[]{"sedimentary","igneous intrusive"},                          5, 110, 60, 40));
		oreList.put("Pitchblende"    , getOreData("Pitchblende"  ,"veins",  "small",  MOD_ID + ":Ore2", 10,  70, new String[]{"igneous extrusive", "igneous intrusive"},                   5, 110, 60, 40));
		oreList.put("Cinnabar"       , getOreData("Cinnabar"     ,"veins",  "small",  MOD_ID + ":Ore2", 11, 100, new String[]{"igneous extrusive", "metamorphic", "sedimentary"},          5, 110, 15, 40));
		oreList.put("Cryolite"       , getOreData("Cryolite"     ,"veins",  "small",  MOD_ID + ":Ore2", 12,  50, new String[]{"granite"},                                                  5, 110, 60, 40));
		oreList.put("Saltpeter"      , getOreData("Saltpeter"    ,"veins",  "medium", MOD_ID + ":Ore2", 13,  70, new String[]{"sedimentary"},                                              5, 110, 60, 40));
		oreList.put("Sylvite"        , getOreData("Sylvite"      ,"veins",  "medium", MOD_ID + ":Ore2", 15,  50, new String[]{"sedimentary"},                                              5, 110, 70, 20));
		oreList.put("Borax"          , getOreData("Borax"        ,"veins",  "large",  MOD_ID + ":Ore3", 0,   70, new String[]{"rock salt", "limestone"},                                   5, 110, 60, 40));
		oreList.put("Lapis Lazuli"   , getOreData("Lapis Lazuli" ,"veins",  "large",  MOD_ID + ":Ore3", 2,   70, new String[]{"metamorphic"},                                              5, 110, 60, 40));
		oreList.put("Selenite"       , getOreData("Selenite"     ,"veins",  "medium", MOD_ID + ":Ore2", 3,   75, new String[]{"igneous intrusive", "igneous extrusive"},                   5, 110, 40, 40));
		oreList.put("Olivine"        , getOreData("Olivine"      ,"veins",  "small",  MOD_ID + ":Ore3", 1,  140, new String[]{"igneous intrusive", "igneous extrusive"},                   5, 110, 20, 60));
