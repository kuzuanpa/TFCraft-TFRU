...
public class TFC_ConfigFiles
{
	...
	public static void reloadOres()
	{
		...
		oreList.put("Native Copper"  , getOreData("Native Copper"  , "veins",  "large",  MOD_ID + ":Ore1", 0,  170, new String[]{"igneous extrusive", "igneous intrusive"},                   5, 110, 60, 40));
		oreList.put("Native Gold"    , getOreData("Native Gold"    , "veins",  "large",  MOD_ID + ":Ore1", 1,  170, new String[]{"igneous extrusive", "igneous intrusive"},                   5, 110, 60, 40));
		oreList.put("Platinum"       , getOreData("Platinum"       , "veins",  "small",  MOD_ID + ":Ore1", 2,  200, new String[]{"sedimentary"},                                              5, 110, 20, 60));
		oreList.put("Hematite"       , getOreData("Hematite"       , "veins",  "large",  MOD_ID + ":Ore1", 3,  175, new String[]{"igneous extrusive"},                                        5, 110, 60, 40));
		oreList.put("Silver"         , getOreData("Silver"         , "veins",  "medium", MOD_ID + ":Ore1", 4,  130, new String[]{"sedimentary", "metamorphic"},                               5, 110, 60, 40));
		oreList.put("Cassiterite"    , getOreData("Cassiterite"    , "veins",  "medium", MOD_ID + ":Ore1", 5,  200, new String[]{"igneous intrusive", "igneous extrusive"},                   5, 110, 60, 40));
		oreList.put("Galena"         , getOreData("Galena"         , "veins",  "medium", MOD_ID + ":Ore1", 6,  130, new String[]{"igneous extrusive", "metamorphic", "sedimentary"},          5, 110, 60, 40));
		oreList.put("Garnierite"     , getOreData("Garnierite"     , "veins",  "medium", MOD_ID + ":Ore1", 8,  200, new String[]{"gabbro","basalt","diorite"},                                5, 110, 60, 40));
		oreList.put("Malachite"      , getOreData("Malachite"      , "veins",  "large",  MOD_ID + ":Ore1", 9,  130, new String[]{"metamorphic"},                                              5, 110, 60, 40));
		oreList.put("Magnetite"      , getOreData("Magnetite"      , "veins",  "medium", MOD_ID + ":Ore1", 10, 200, new String[]{"sedimentary"},                                              5, 110, 60, 40));
		oreList.put("Limonite"       , getOreData("Limonite"       , "veins",  "medium", MOD_ID + ":Ore1", 11, 130, new String[]{"sedimentary"},                                              5, 110, 60, 40));
		oreList.put("Sphalerite"     , getOreData("Sphalerite"     , "veins",  "medium", MOD_ID + ":Ore1", 12, 130, new String[]{"metamorphic"},                                              5, 110, 60, 40));
		oreList.put("Tetrahedrite"   , getOreData("Tetrahedrite"   , "veins",  "medium", MOD_ID + ":Ore1", 13, 170, new String[]{"metamorphic","sedimentary"},                                5, 110, 60, 40));
		oreList.put("Lignite"        , getOreData("Lignite"        , "default","medium", MOD_ID + ":Ore1", 15, 130, new String[]{"metamorphic"},                                              5, 110, 70, 20));
		oreList.put("Kaolinite"      , getOreData("Kaolinite"      , "default","medium", MOD_ID + ":Ore2", 0,  110, new String[]{"sedimentary", "metamorphic"},                               5, 110, 60, 40));
		oreList.put("Gypsum"         , getOreData("Gypsum"         , "veins",  "large",  MOD_ID + ":Ore2", 1,  170, new String[]{"sedimentary"},                                              5, 110, 60, 40));
		oreList.put("Graphite"       , getOreData("Graphite"       , "veins",  "medium", MOD_ID + ":Ore2", 4,  130, new String[]{"metamorphic", "sedimentary"},                               5, 110, 60, 40));
		oreList.put("Kimberlite"     , getOreData("Kimberlite"     , "veins",  "medium", MOD_ID + ":Ore2", 5,  250, new String[]{"gabbro","basalt","diorite"},                                5, 110, 15, 60));
		oreList.put("Jet"            , getOreData("Jet"            , "veins",  "medium", MOD_ID + ":Ore2", 8,  160, new String[]{"sedimentary","igneous intrusive"},                          5, 110, 60, 40));
		oreList.put("Pitchblende"    , getOreData("Pitchblende"    , "veins",  "small",  MOD_ID + ":Ore2", 10, 170, new String[]{"igneous extrusive", "igneous intrusive"},                   5, 110, 60, 40));
		oreList.put("Cinnabar"       , getOreData("Cinnabar"       , "veins",  "small",  MOD_ID + ":Ore2", 11, 200, new String[]{"igneous extrusive", "metamorphic", "sedimentary"},          5, 110, 15, 40));
		oreList.put("Cryolite"       , getOreData("Cryolite"       , "veins",  "small",  MOD_ID + ":Ore2", 12, 130, new String[]{"granite"},                                                  5, 110, 60, 40));
		oreList.put("Saltpeter"      , getOreData("Saltpeter"      , "veins",  "medium", MOD_ID + ":Ore2", 13, 170, new String[]{"sedimentary"},                                              5, 110, 60, 40));
		oreList.put("Sylvite"        , getOreData("Sylvite"        , "veins",  "medium", MOD_ID + ":Ore2", 15, 130, new String[]{"sedimentary"},                                              5, 110, 70, 20));
		oreList.put("Borax"          , getOreData("Borax"          , "veins",  "large",  MOD_ID + ":Ore3", 0,  170, new String[]{"rock salt", "limestone"},                                   5, 110, 60, 40));
		oreList.put("Lapis Lazuli"   , getOreData("Lapis Lazuli"   , "veins",  "large",  MOD_ID + ":Ore3", 2,  170, new String[]{"metamorphic"},                                              5, 110, 60, 40));
		oreList.put("Selenite"       , getOreData("Selenite"       , "veins",  "medium", MOD_ID + ":Ore2", 3,  175, new String[]{"igneous intrusive", "igneous extrusive"},                   5, 110, 40, 40));
		oreList.put("Olivine"        , getOreData("Olivine"        , "veins",  "small",  MOD_ID + ":Ore3", 1,  200, new String[]{"igneous intrusive", "igneous extrusive"},                   5, 110, 20, 60));
		oreList.put("Microcline"     , getOreData("Microcline"     , "veins",  "large",  MOD_ID + ":Ore2", 9,  150, new String[]{"sedimentary"},                                              5, 110, 40, 40));
