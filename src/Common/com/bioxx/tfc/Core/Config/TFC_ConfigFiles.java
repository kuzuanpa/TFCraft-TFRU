...
public class TFC_ConfigFiles
{
	...
	private static OreSpawnData getOreData(String category, String type, String size, String blockName, String flowerName, int flowerMeta, int meta, int rarity, String[] rocks, int minHeight, int maxHeight, int densityVertical, int densityHorizontal)
	{
		return getOreData(category, type, size, blockName, meta, rarity, rocks, minHeight, maxHeight, densityVertical, densityHorizontal).setFlower(flowerName, flowerMeta);
	}
